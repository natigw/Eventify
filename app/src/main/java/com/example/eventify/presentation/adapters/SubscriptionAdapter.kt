...
//    val context: Context,  //TODO -> data backendden gelende contexti burdan sil
...
//        SubscriptionData(
//            name = context.getString(R.string.base),
//            features = context.getString(R.string.base_package_features), //[Feature1, Feature2, ..] ??
//            priceMonthly = 0.0,
//            priceAnnually = 0.0
//        ),
////        SubscriptionData(
...
//                textPriceSubscription.text = context.getString(R.string.free)
//                textMonthlyAnnuallySubscription.visibility = View.GONE
//                textSaveMoneySubscription.visibility = View.INVISIBLE
//                buttonChoosePackageSubscription.text = context.getString(R.string.try_)
//            }
//            else {
//                textPriceSubscription.text = if (isAnnual) "$${item.priceAnnually}" else "$${item.priceMonthly}"
//                textMonthlyAnnuallySubscription.text = if (isAnnual) context.getString(R.string.slash_year) else context.getString(R.string.slash_month)
//                textSaveMoneySubscription.text = "${context.getString(R.string.save)} $${item.priceMonthly*12 - item.priceAnnually}"
//            }
//
//            if (item.name == currentPackage) {
//                buttonChoosePackageSubscription.text = context.getString(R.string.current_plan)
